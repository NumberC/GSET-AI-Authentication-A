...
param_len_signal = 16e3; %length of 10 chirps plus gap following each chirp
...
disp(param_len_pilot+param_len_sbuffer+1)
disp(length(param_chirp_sig)-1)
mic_a = mic_a( ...
...
for j = 1:param_num_signals
    for i = 1:1:10 % Up to 20 because there are only 10 chirp repetitions
